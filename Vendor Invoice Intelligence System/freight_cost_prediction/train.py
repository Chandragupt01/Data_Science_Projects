...
def main():
    db_path=r"C:/Users/spsbh/Desktop/collegeNotes/ML_DS_Projects/Data_Science_Projects/Vendor Invoice Intelligence System/data/inventory.db"
    model_dir=Path("Vendor Invoice Intelligence System/models")
    ...
    best_model={
        ...
        "Random_Forest Regression":rf_model
    }[best_model_name]
